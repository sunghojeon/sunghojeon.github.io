---
layout: post
title: 드론 기반 지상파 DTV 방송국 안테나 패턴 현장 검증 @ ATSC IT-5
---

□ 발표 개요

 o 회의명: ATSC Implementation Team 5: Tower Network (IT-5)
...
□ 발표 핵심 내용
 ...
 o 방송 타워 인근 드론 운용 환경 분석: EMI 포화, 자기장 교란, GPS 드리프트

 o RF hardening과 운용 제약(나침반 사용 제한, RTK 보정 병목) 대응 전략

 o 사전 수직 사운딩 기반 전기적 중심점 식별 및 측정 경로 설계

 o 3D 복사 패턴 측정 데이터를 2D 검증으로 연계하는 방법론

 o 기존 지상/헬기 측정 대비 드론 측정의 효율성, 비용, 안전성 비교

 o 측정 불확도 분석 및 안테나 검증 표준화 방향 제시
